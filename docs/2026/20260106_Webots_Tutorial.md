...
## 摘要
  本文主要对 webots 开发环境的安装配置，以及webots开发的一些核心功能与概念做介绍，更加详细且系统的教程可见网上资源，比如[该教程](https://www.bilibili.com/opus/678930782193975296)。
  本文首先介绍一下 webots 开发环境的安装配置，包括 webots、webots_ros2包；接着本文着重对 webots 里常用的一些核心概念，如世界文件、场景树（Scene Tree）、节点、铰链等进行介绍。

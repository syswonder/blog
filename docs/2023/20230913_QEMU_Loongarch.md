...
![image-20231019104750349](20230913_QEMU_Loongarch.assets/image-20231019104750349.png)
...
![image-20231019105726634](20230913_QEMU_Loongarch.assets/image-20231019105726634.png)

![image-20231019112521036](20230913_QEMU_Loongarch.assets/image-20231019112521036.png)
...
![image-20231019122217141](20230913_QEMU_Loongarch.assets/image-20231019122217141.png)

![image-20231019122316095](20230913_QEMU_Loongarch.assets/image-20231019122316095.png)

得到树莓派和qemu的jailhouse镜像

![image-20231019122346750](20230913_QEMU_Loongarch.assets/image-20231019122346750.png)

### 烧写SD卡

首先找到sd卡（USB读卡器）的设备号 - `lsblk`

![image-20231019122913673](20230913_QEMU_Loongarch.assets/image-20231019122913673.png)
...
![image-20231019132842768](20230913_QEMU_Loongarch.assets/image-20231019132842768.png)

![image-20231019132906493](20230913_QEMU_Loongarch.assets/image-20231019132906493.png)

### 启动机器

树莓派使用串口转USB连接到电脑（PL2303）

![image-20231019123554356](20230913_QEMU_Loongarch.assets/image-20231019123554356.png)

这里使用windows下的xshell登录串口（由于未知原因，我在linux下使用screen、stty或minicom均无法输入），首先测试一下raspi os的串口终端运行情况：

![image-20231019132101667](20230913_QEMU_Loongarch.assets/image-20231019132101667.png)

之后更换为jailhouse的SD卡运行
